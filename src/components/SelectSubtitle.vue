<template>
	<q-dialog v-model="showSelectSubtitleDialog" persistent position="top" transition-show="slide-up" transition-hide="slide-down">
		<q-card class="mma-card" v-if="subtitleLists.length">
			...
			<q-card-section class="q-pr-lg">
				<q-row class="q-col-gutter-sm">
					<q-col class="col-12" v-for="each in subtitleLists" :key="each.id">
